<template>
	<el-dialog v-model="visible" :close-on-click-modal="false" title="添加课堂资源" draggable>
...
import { useLessonResourceSubmitApi } from '@/api/lessons/resource'
...
const submitHandle = () => {
	...
	useLessonResourceSubmitApi(dataForm).then((res: any) => {
		if ((res.msg = 'success')) {
