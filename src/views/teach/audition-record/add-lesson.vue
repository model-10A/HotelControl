...
import Step1 from '@/views/teach/audition-record/step/step1.vue'
import Step2 from '@/views/teach/audition-record/step/step2.vue'
import { ElMessage } from 'element-plus'
import {createAuditionLessonApi} from "@/api/lessons/lesson";
...
const submitHandle = () => {
  createAuditionLessonApi(dataForm).then(() => {
		ElMessage.success({
			message: '操作成功',
			duration: 500,
			onClose: () => {
