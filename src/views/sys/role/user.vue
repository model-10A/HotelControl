...
import { dataListRoleUserUrl, deleteRoleUserUrl, useRoleUserSubmitApi } from '@/api/sys/role'
...
const state: IHooksOptions = reactive({
	dataListUrl: dataListRoleUserUrl,
	deleteUrl: deleteRoleUserUrl + '/' + props.roleId,
	queryForm: {
		roleId: props.roleId,
		username: '',
		mobile: '',
