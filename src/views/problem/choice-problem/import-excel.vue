<template>
	<el-dialog v-model="visible" title="Excel导入" width="40%" :close-on-click-modal="false" draggable>
		<el-form ref="dataFormRef" style="max-height: 60vh; overflow: auto" label-width="100px">
			<el-form-item label="模板">
				<el-button type="primary" @click="downloadProblemTemplate(1)">下载模板</el-button>
			</el-form-item>
...
import { useImportExcelApi } from '@/api/problem/choiceproblem.ts'
