<template>
	<el-card>
      ...
      <el-form-item>
        <el-button type="primary" @click="insertBatchHandle()">引入</el-button>
      </el-form-item>
		</el-form>
    ...
    <insert-teacher ref="insertTeacherRef"></insert-teacher>
	</el-card>
</template>
...
import { dataListUrl, deleteUrl, resetPassword } from '@/api/teach/teacher'
import { ElMessage } from 'element-plus'
import { useUserInfoApi } from '@/api/sys/user'
import InsertTeacher from './insert-teacher.vue'
...
const insertTeacherRef = ref()
const insertBatchHandle = () =>{
  insertTeacherRef.value.init()
}
