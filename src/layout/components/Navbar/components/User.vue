...
<!--				<router-link to="/profile/personal-center">-->
<!--					<el-dropdown-item> {{ $t('router.personalCenter') }} </el-dropdown-item>-->
<!--				</router-link>-->
				<router-link to="/profile/password">
					<el-dropdown-item> {{ $t('router.profilePassword') }} </el-dropdown-item>
				</router-link>
				<router-link to="/profile/share-code">
					<el-dropdown-item> {{ $t('router.shareCode') }} </el-dropdown-item>
				</router-link>
